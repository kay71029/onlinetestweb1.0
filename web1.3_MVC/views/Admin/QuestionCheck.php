  ...
  <div class="panel-body">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>
        <a href= "QuestionModify?chqu_id=<?PHP echo $row['q_id']; ?>"class="btn btn-default navbar-btn" >修改</a>
        </td>
        <td>
        <a href= "QuestionDE?q_id=<?PHP echo $row['q_id']; ?>"class="btn btn-default navbar-btn" >刪除</a>
        </td>
      </tr>
      <?php } ?>
    </table>
