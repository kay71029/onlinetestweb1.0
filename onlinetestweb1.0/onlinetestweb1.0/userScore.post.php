<?php
  ...
  $result_se_requinner_str = mysql_query($sql_se_requinner_str);
  ...
  $result_question = mysql_query( $sql_se_requinner_str);
...
?>
    ...
    <table class="table">
            ...
            <?php while ($row =mysql_fetch_assoc($result_se_requinner_str)) { ?> 
            <tr>
...
<!-- Modal -->
<?php while ($row2 =mysql_fetch_assoc($result_question)) { ?> 
<div class="modal fade" id="myModal<?PHP echo $row2['q_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
