  ...
  <div class="panel-body">
    <form method = "post" action ="Modify">    
        <div class="input-group input-group-lg"> 
           ...
           <input type="text" class="form-control" VALUE="<?PHP echo $data->user_id;?>" placeholder="UserID" aria-describedby="sizing-addon1" name="fid" disabled required >
        </div>
          <br>
        <div class="input-group input-group-lg"> 
            <span class="input-group-addon" id="sizing-addon1">姓名</span></span>
            <input type="text" class="form-control" VALUE="<?PHP echo $data->user_name;?>" placeholder="UserName" aria-describedby="sizing-addon2" name="fname" disabled required  >
        </div>
          <br>
        <div class="input-group input-group-lg"> 
            <span class="input-group-addon" id="sizing-addon1">密   碼</span></span>
            <input type="password" class="form-control" VALUE="<?PHP echo $data->user_password;?>" placeholder="Password" aria-describedby="sizing-addon3" name="fpwd" required="">
        </div>
          <br>
        <div class="input-group input-group-lg"> 
        ...
        <div class="input-group input-group-lg"> 
            ...
            <input type="email" class="form-control" VALUE="<?PHP echo $data->user_email;?>" placeholder="Email" aria-describedby="sizing-addon5" name="femail" required="">
        </div>
          <br>
          <div class="input-group input-group-lg"> 
            <span class="input-group-addon" id="sizing-addon1">電話</span></span>
            <input type="text" class="form-control" VALUE="<?PHP echo $data->user_tel;?>" placeholder="0910-123456" aria-describedby="sizing-addon5" name="ftel" required="">
        </div>
          <br>
          <br>
